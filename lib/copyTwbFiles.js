/*
	...
	files and copy globs to the specified destination.
*/
...
//
// copyTwbFiles(twbPath, twbPkg, destPkgPrefix, dest, callback)
function copyTwbFiles(twbPath, twbPkg, destPkgPrefix, dest, callback) {
	...
	async.series([
		...
		function (cb) {
			...
			var ctx = { pkg: twbPkg, bootstrap: bootstrap, destPkgPrefix: destPkgPrefix };
